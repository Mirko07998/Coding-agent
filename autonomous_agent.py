        ...
        try:
            ...
            if push_to_github:
                ...
                try:
                    ...
                    # Auto-create pull request after successful push
                    pr_title = f"{ticket_key}: {ticket_info['summary']}"
                    pr_body = (
                        f"Automated changes for {ticket_key}\n\n"
                        f"- Status: {ticket_info.get('status', 'N/A')}\n"
                        f"- Assignee: {ticket_info.get('assignee', 'Unassigned')}\n"
                        f"- Jira URL: {ticket_info.get('url', 'N/A')}\n\n"
...
def main():
    ...
    print(f"Pull Request: {results.get('pr_url') or 'Not created'}")
